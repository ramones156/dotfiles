...
local function create_boxed_widget(widget_to_be_boxed, width, height)
    ...
    box_container.bg = beautiful.transparent
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local analog_clock_boxed = create_boxed_widget(analog_clock, dpi(190), dpi(190))
    ...
    awful.placement.top_right(s.wifi_tooltip, {
        margins = {
            top = beautiful.useless_gap * 16,
            bottom = beautiful.useless_gap * 6,
            left = beautiful.useless_gap * 6,
...
function wifi_tooltip_toggle()
    local s = awful.screen.focused()
    s.wifi_tooltip.visible = not s.wifi_tooltip.visible
end
